<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Recognition.aspx.cs" Inherits="hackathonupdated.Recognition" %>
...
<body class="">
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:;">Recognition</a>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-warning">
                                    <h4 class="card-title ">Recognition Details </h4>
                                    <p class="card-category">Below are the list of Rewards and shoutouts received the user.</p>
                                </div>
           
                                <div class="card-body">
                                    <div class="table-responsive">
                          
      <div class="spinner-border text-warning" style ="margin-top:1%;margin-left:45%" id="cspinner"></div>
                                        <table class="table">
                                            <thead id="thRecognition" hidden="true" class=" text-warning">
                                                <tr>
                                                    <td><b>Slno</b></td>
                                                    <td><b>Body</b></td>
    ...
    <script>
     ...
     function   bindRewardDetails(){
         $.ajax({
             type: "GET",
             url: '<%=ResolveUrl("~/Recognition.aspx/GetRecognitionDetails") %>',
              data: {},
                 ...
                 debugger;
                  ...
                  if (response.d.length > 0) {
                      ...
                      for (var i = 0; i < response.d.length; i++) {
                          ...
                          lbody = lbody + '<tr>' +
                              '<td>' + temp+ ' </td>' +
                              "<td style='width: 650px'>" + data[i].Content + ' </td>' +
                      ...
                      $("#tbRecognition").html(lbody);
                  }
              },
             complete: function () {
                 $("#thRecognition").removeAttr('hidden');
