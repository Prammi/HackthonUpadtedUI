<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PTODetails.aspx.cs" Inherits="hackathonupdated.PTODetails" %>
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:;">PTO Details</a>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-danger">
                                    <h4 class="card-title ">PTO details </h4>
                                    <p class="card-category">Below are the list of PTOS taken by the user.</p>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody id="tbPTO">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>8</td>
                                                    <td>29/03/2020</td>
                                                    <td>OOO due to personal emergency</td>
                                                </tr>
                                                <tr>
                                                    <td>3</td>
                                                    <td>Casual</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>8</td>
                                                    <td>28/07/2020</td>
                                                    <td>Comp off for working on Ramzan</td>
                                                </tr>
                                                <tr>
                                                    <td>8</td>
                                                    <td>Casual</td>
